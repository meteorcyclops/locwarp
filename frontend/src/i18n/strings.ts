...
export const STRINGS = {
  ...
  'connection.health_connected': { zh: 'USB 連線穩定', en: 'USB connection stable' },
  'connection.health_connected_unstable': { zh: 'USB 已連線，但穩定度偏低', en: 'USB connected, but unstable' },
  'connection.health_connected_detail': { zh: 'USB 與 iOS 定位通道均已就緒', en: 'USB and iOS location channel are ready' },
  'connection.health_wifi_connected': { zh: 'WiFi 連線穩定', en: 'Wi-Fi connection stable' },
  'connection.health_wifi_connected_unstable': { zh: 'WiFi 已連線，但穩定度偏低', en: 'Wi-Fi connected, but unstable' },
  'connection.health_wifi_connected_detail': { zh: 'WiFi 與 iOS 定位通道均已就緒', en: 'Wi-Fi and iOS location channel are ready' },
  'connection.health_uptime': { zh: '已連續連線 {value}', en: 'Connected for {value}' },
  'connection.health_duration_seconds': { zh: '{n} 秒', en: '{n}s' },
  'connection.health_duration_minutes': { zh: '{n} 分鐘', en: '{n}m' },
  'connection.health_duration_hours': { zh: '{h} 小時 {m} 分', en: '{h}h {m}m' },
  'connection.health_last_reconnect': { zh: '最近重連 {time}', en: 'Last reconnected {time}' },
  'connection.health_last_disconnect': { zh: '最近中斷 {time}', en: 'Last disconnected {time}' },
  'connection.health_stabilizing': { zh: 'USB 穩定度確認中 · {current}/{required}', en: 'Checking USB stability · {current}/{required}' },
  'connection.health_stabilizing_detail': { zh: '已連續通過 {current} 次檢查，還需 {remaining} 次（每秒檢查）', en: '{current} consecutive checks passed; {remaining} remaining (checked every second)' },
  'connection.health_connecting': { zh: '正在建立裝置連線 · 第 {n} 次', en: 'Connecting device · attempt {n}' },
  'connection.health_connecting_detail': { zh: 'USB 檢查已通過，正在建立 iOS 定位通道', en: 'USB checks passed; opening the iOS location channel' },
  'connection.health_backoff': { zh: '自動重連等待中', en: 'Waiting to reconnect' },
  'connection.health_absent': { zh: 'USB 未偵測到', en: 'USB not detected' },
  'connection.health_absent_detail': { zh: '請確認線材、接頭，並保持 iPhone 解鎖', en: 'Check the cable and connector, and keep the iPhone unlocked' },
  'connection.health_retry': { zh: '約 {n} 秒後重試', en: 'Retrying in about {n}s' },
  'connection.health_disconnects': { zh: '近 5 分鐘中斷 {n} 次', en: '{n} disconnects in 5 minutes' },
  'connection.location_active': { zh: '定位更新正常', en: 'Location updates healthy' },
  'connection.location_recovering': { zh: '定位通道恢復中', en: 'Recovering location channel' },
  'connection.location_last_success': { zh: '最近成功更新 {value}前', en: 'Last successful update {value} ago' },
  'connection.location_last_success_seconds': { zh: '最近成功更新 {n} 秒前', en: 'Last successful update {n}s ago' },
  'connection.location_last_success_none': { zh: '尚未成功更新 GPS', en: 'No successful GPS update yet' },
  'connection.location_pending_detail': { zh: 'GPS 待首次驗證', en: 'GPS pending first verification' },
  'connection.location_stalled': { zh: '已停滯 {value}', en: 'Stalled for {value}' },
  'connection.location_rebuilding': { zh: '正在重建 RSD / DVT 通道', en: 'Rebuilding RSD / DVT channel' },
  'connection.location_recovered': { zh: '最近自動恢復 {time}', en: 'Last auto-recovered {time}' },
  ...
  'status.restart_backend': { zh: '重啟 Backend', en: 'Restart Backend' },
  'status.restart_backend_tooltip': { zh: '當裝置抓不到、usbmux 抽風或 backend 卡住時，重新啟動 LocWarp backend', en: 'Restart the LocWarp backend when device detection, usbmux, or the backend itself gets stuck' },
  'status.restart_backend_busy': { zh: '重啟中...', en: 'Restarting...' },
  'status.restart_backend_in_progress': { zh: '正在重啟 LocWarp backend,請稍候...', en: 'Restarting the LocWarp backend, please wait...' },
  'status.restart_backend_success': { zh: 'LocWarp backend 已重啟，裝置清單已重新掃描', en: 'LocWarp backend restarted and the device list was refreshed' },
  'status.restart_backend_success_waiting_device': { zh: 'LocWarp backend 已重啟，但目前還沒看到 iPhone，若仍無法抓到請重插 USB', en: 'LocWarp backend restarted, but no iPhone is visible yet. Replug USB if it still does not appear.' },
  'status.restart_backend_failed': { zh: '重啟 LocWarp backend 失敗', en: 'Failed to restart the LocWarp backend' },
  'status.restart_backend_unavailable': { zh: '目前環境不支援從 UI 重啟 backend', en: 'This environment does not support restarting the backend from the UI' },
  ...
  'group.device_recovering': { zh: '恢復中', en: 'Recovering' },
  'group.device_offline': { zh: '離線', en: 'Offline' },
  'group.reconnecting': { zh: '{ready}/{total} 重連中 · 嘗試 {attempt}/{max}', en: '{ready}/{total} reconnecting · attempt {attempt}/{max}' },
  'group.max_sync_delta': { zh: '最大同步偏差 {ms} ms', en: 'Max sync delta {ms} ms' },
  'wifi.reconnect_last_ip': { zh: '正在嘗試上次 IP', en: 'Trying the previous IP' },
  'wifi.reconnect_network_changed': { zh: '已換網路，重新尋找', en: 'Network changed, searching again' },
  'wifi.reconnect_found': { zh: '找到 {name}', en: 'Found {name}' },
  'wifi.reconnect_tunnel': { zh: '正在建立 Tunnel', en: 'Establishing tunnel' },
  'wifi.reconnect_retrying': { zh: '暫時找不到，將自動重試', en: 'Not found yet, retrying automatically' },
  'wifi.reconnect_needs_usb': { zh: '配對已失效，請接 USB 重新配對', en: 'Pairing expired; reconnect USB to pair again' },
  'wifi.reconnect_attempt': { zh: '第 {n} 次', en: 'attempt {n}' },
  ...
  'goldditto.hold_label': { zh: 'A 停留時間', en: 'A hold time' },
  'goldditto.hold_hint': { zh: '按下後在 A 座標停留多久再還原，預設 500ms', en: 'How long to stay at A before restore, default 500ms' },
  'goldditto.hold_placeholder': { zh: '例: 500', en: 'e.g. 500' },
  'goldditto.flow_help': {
    zh: '操作流程: 手動飛到金盆點開花苞,等待「在特殊花朵上往下滑動就能獲得獎勵」提示出來,再等 2 秒,再按下方「拉金盆」開始拉盆。下方可調整按下後在 A 座標停留多久再還原。',
    en: 'Flow: manually fly to the gold flower spot and open the bud. Wait for the "Swipe down on the special flower for a reward" prompt, then wait another 2 seconds before tapping below. You can adjust how long the app stays at A before restoring.',
  },
  ...
  'goldditto.toast.invalid_hold': { zh: 'A 停留時間格式有誤', en: 'A hold time is malformed' },
  ...
  'wifi.warning_body': {
    zh: '本 WiFi Tunnel(USB 拔除)模式透過 pymobiledevice3 的 RemotePairing 協議與 iOS 裝置建立 TLS-PSK 加密通道,再於其上封裝 TCP tunnel 以存取 RemoteXPC / RSD 服務。需 Python 3.13+ 的原生 TLS-PSK 支援,且必須先經 USB 配對、取得 remote pair record 方可使用。macOS 版使用程式內 userspace tunnel,不需要系統管理員權限。\n\n由於各家網路卡驅動、VPN 客戶端、第三方防火牆、路由器 mDNS/Bonjour 支援與作業系統修補等級差異,部分環境可能出現以下情況:\n\n• RemotePairing 握手失敗或 RSD 連線逾時\n• 裝置 IP/Port 無法被自動探索\n• iPhone 螢幕鎖定或 WiFi 瞬斷時 tunnel 斷線須重連\n\n若您的環境無法成功建立 Tunnel,建議改用 USB 連線;USB 模式透過 usbmuxd 相容性最佳且不需此側欄。',
    en: 'WiFi Tunnel (USB-free) mode uses pymobiledevice3\'s RemotePairing protocol to open a TLS-PSK encrypted channel with the iOS device, then layers a TCP tunnel on top for access to RemoteXPC / RSD services. Python 3.13+ is required (for native TLS-PSK) and the device must have been paired over USB first so that a remote pair record exists. On macOS the in-process userspace tunnel does not require Administrator privileges.\n\nBecause NIC drivers, VPN clients, third-party firewalls, router mDNS/Bonjour behavior and OS patch levels vary widely, some environments may see:\n\n• RemotePairing handshake failure or RSD connection timeout\n• Device IP/port cannot be auto-discovered\n• Tunnel drops and needs reconnection when the iPhone screen locks or Wi-Fi briefly fluctuates\n\nIf the tunnel cannot be established in your environment, please use a USB connection instead. USB mode goes through usbmuxd and has the best compatibility.',
  },
  ...
  'wifi.repair_confirm_body': { zh: '此動作會用 USB 重建 RemotePairing 記錄。過程中 iPhone 可能會跳「信任這台電腦」,請解鎖並按信任。完成後請拔除 USB,再啟動 WiFi Tunnel。\n\n確定要繼續嗎?', en: 'This rebuilds the RemotePairing record via USB. Your iPhone may show "Trust This Computer"; unlock it and tap Trust. When it finishes, unplug USB before starting WiFi Tunnel.\n\nContinue?' },
  'wifi.repair_running': { zh: '配對中...請在 iPhone 上按「信任」', en: 'Pairing... tap Trust on the iPhone' },
  'wifi.repair_success': { zh: '配對成功!請拔除 USB,再啟動 WiFi Tunnel', en: 'Paired! Unplug USB, then start WiFi Tunnel' },
  'wifi.repair_failed': { zh: '配對失敗', en: 'Pairing failed' },
  'wifi.repair_cancel': { zh: '取消', en: 'Cancel' },
  'wifi.repair_ok': { zh: '開始配對', en: 'Start pairing' },
  'ddi.mount_button': { zh: '掛載 DDI', en: 'Mount DDI' },
  'ddi.mount_tooltip': { zh: '用本機已快取的 Personalized DDI 掛載到這支 iPhone，完成後會刷新 USB 連線', en: 'Mount the cached personalized DDI onto this iPhone, then refresh the USB connection' },
  'ddi.mount_running': { zh: '掛載中...', en: 'Mounting...' },
  'ddi.mount_success': { zh: 'DDI 已掛載', en: 'DDI mounted' },
  'ddi.mount_failed': { zh: 'DDI 掛載失敗', en: 'DDI mount failed' },
  ...
  'wifi.recent_ip_delete_tooltip': { zh: '移除此筆最近連線', en: 'Remove this recent connection' },
  ...
  'wifi.discovery_model_unknown': { zh: '型號未提供', en: 'Model unavailable' },
  'wifi.discovery_udid_unknown': { zh: 'UDID 尾碼未知', en: 'UDID suffix unavailable' },
  'wifi.tunnel_usb_can_disconnect': { zh: 'USB 可拔除', en: 'USB can be disconnected' },
  'wifi.tunnel_admin_hint': { zh: '請先通過 USB 信任與配對,再拔除 USB 後啟動。macOS 不需管理員權限。', en: 'Pair and trust over USB first, then unplug USB before starting. No Administrator access is needed on macOS.' },
  ...
  'diagnostics.group_title': { zh: '系統診斷', en: 'System diagnostics' },
  'diagnostics.core_versions': { zh: '核心版本', en: 'Core versions' },
  'diagnostics.app': { zh: '應用程式', en: 'Application' },
  'diagnostics.backend': { zh: '後端', en: 'Backend' },
  'diagnostics.platform': { zh: '平台', en: 'Platform' },
  ...
  'diagnostics.devices': { zh: '裝置 / GPS', en: 'Devices / GPS' },
  'diagnostics.recovering': { zh: '恢復中', en: 'recovering' },
  'diagnostics.wifi_tunnels': { zh: 'Wi‑Fi Tunnel', en: 'Wi-Fi tunnels' },
  'diagnostics.screen_capture': { zh: '螢幕擷取', en: 'Screen capture' },
  'diagnostics.supported': { zh: '可用', en: 'available' },
  'diagnostics.unsupported': { zh: '不支援', en: 'unsupported' },
  'diagnostics.not_verified': { zh: '未驗證', en: 'Not verified' },
  'diagnostics.uptime': { zh: 'Backend 運作時間', en: 'Backend uptime' },
  'diagnostics.strict_group': { zh: '嚴格同步群組', en: 'Strict sync group' },
  'diagnostics.missing': { zh: '缺少', en: 'missing' },
  'diagnostics.last_checked': { zh: '最近檢查', en: 'Last checked' },
